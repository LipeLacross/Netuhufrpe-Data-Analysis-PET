...
dados["idade_norm"] = pandas.to_numeric(dados["idade"], errors='coerce')#Vai converter a coluna idade para uma nova coluna chamada idade_norm, e vai colocar só os dados que seguem o tipo certo. #Que nesse caso é float
...
print("o devio padrão das idades em 2022 dos vacinados são", math.sqrt(var_idade))#Usou-se a raiz quadrada porque alguns dados estão com valores bem anormais(para alto ou baixo)
